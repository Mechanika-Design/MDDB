...
MDDB::ConvertFromDBTime($field, $gmt = true)
--------------------------------------------
...
MDDB::ProcessSubqueries(&$result, &$master, $subqueries)
--------------------------------------------------------
...
MDDB::RunRowFilter(&$row, &$filteropts, &$fetchnext)
----------------------------------------------------
...
MDDB::ProcessDELETE(&$master, &$sql, &$opts, $queryinfo, $args, $subquery, $supported)
--------------------------------------------------------------------------------------
