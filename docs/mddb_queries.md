...
The DATE, TIME, and DATETIME fields may result in an equivalent STRING type under some databases.  The MDDB date/time manipulation functions should be used, which will mitigate this issue.
